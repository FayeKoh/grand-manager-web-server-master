...
function exportExcel(table, title, statisticsDate) {
  ...
  mySheet['A1'].v = "GRAND Manager-停车管理-停车记录管理"
  ...
  mySheet['!cols'] = [
    { wpx: 80 }, { wpx: 100 }, { wpx: 100 }, { wpx: 150 }, { wpx: 100 }, { wpx: 150 }, { wpx: 150 }, { wpx: 100 }, { wpx: 100 }, { wpx: 100 }
  ]
  ...
  openDownloadDialog(blob, 'GRAND Manager-停车管理-停车记录管理' + '-' + '.xlsx');
}
function s2ab(s) {
